...
class Client extends BaseClient
{
    ...
    {
        return $this->postJson('chat/send', [
    ...
    {
        return $this->_GET('chat/getReadList', [
    ...
    {
        return $this->postJson('chat/create', $params);
    }
    ...
    {
        return $this->postJson('chat/update', ['chatid' => $chatId] + $params);
    }
    ...
    {
        return $this->_GET('chat/get', ['chatid' => $chatId]);
    }
}
