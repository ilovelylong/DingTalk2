...
class Client extends BaseClient
{
    ...
    {
        return $this->postJson('topapi/workrecord/add', $params);
    }
    ...
    {
        return $this->postJson('topapi/workrecord/update', ['userid' => $userId, 'record_id' => $recordId]);
    }
    ...
    {
        return $this->postJson('topapi/workrecord/getbyuserid', [
            'userid' => $userId,
