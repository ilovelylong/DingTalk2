...
class Client extends BaseClient
{
    ...
    {
        return $this->postJson('message/send_to_conversation', [
    ...
    {
        return $this->_POST('topapi/message/corpconversation/asyncsend_v2', $params);
    }
    ...
    {
        $client = new class($this->app) extends Client {
            /**
             * 任务 ID
             *
             * @var int
            ...
            {
                return $this->postJson('topapi/message/corpconversation/getsendprogress', [
            ...
            {
                return $this->postJson('topapi/message/corpconversation/getsendresult', [
                    'agent_id' => $this->app['config']['agent_id'], 'task_id' => $this->taskId,
                ]);
            }
        };
