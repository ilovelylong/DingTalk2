...
class Client extends BaseClient
{
    ...
    {
        return $this->postJson('topapi/report/list', $params);
    }
    ...
    {
        return $this->postJson('topapi/report/template/listbyuserid', [
    ...
    {
        return $this->postJson('topapi/report/getunreadcount', compact('userid'));
    }
    ...
    {
        return $this->postJson('topapi/report/statistics', compact('report_id'));
    }
    ...
    {
        return $this->postJson('topapi/report/statistics/listbytype', [
    ...
    {
        return $this->postJson('topapi/report/receiver/list', [
    ...
    {
        return $this->postJson('topapi/report/comment/list', [
            'report_id' => $report_id, 'offset' => $offset, 'size' => $size
        ]);
    }
